...
const ParentParser_1 = __importDefault(__webpack_require__(2));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.EOL = exports.getType = exports.testData = exports.ItemType = void 0;
var ItemType;
(function (ItemType) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const php_parser_1 = __webpack_require__(6);
const vscode = __importStar(__webpack_require__(1));
const utils_1 = __webpack_require__(4);
class TestCasesParser {
    ...
    async discover(test) {
        ...
        const parentTest = (0, utils_1.getType)(test);
...
const lexer = __webpack_require__(7);
const parser = __webpack_require__(17);
const tokens = __webpack_require__(35);
const AST = __webpack_require__(36);
...
const Position = __webpack_require__(18);
...
const Location = __webpack_require__(37);
const Position = __webpack_require__(18);
...
const Expr = __webpack_require__(39);
const KIND = "array";
...
const Node = __webpack_require__(40);
...
const Expression = __webpack_require__(39);
...
const Operation = __webpack_require__(47);
const KIND = "bin";
/**
 * Binary operations
 * @constructor Bin
...
const Statement = __webpack_require__(49);
const KIND = "block";
...
const Literal = __webpack_require__(51);
const KIND = "boolean";
...
const Declaration = __webpack_require__(59);
const KIND = "class";
...
const ConstantStatement = __webpack_require__(61);
...
const Function_ = __webpack_require__(85);
const KIND = "method";
...
const Reference = __webpack_require__(104);
const KIND = "name";
...
const Lookup = __webpack_require__(98);
...
class TestRunner {
    ...
    async pushToQueue(tests, runner, request) {
    ...
    determineTheCommandToRun(request) {
        if (!request.include) {
            return;
        }
    }
...
class TestCommandHandler {
    ...
    constructor(request, controller, runner, queue = []) {
    ...
    run() {
        if (this.request.include?.length) {
            this.request.include.forEach(testItem => {
                const info = (0, utils_1.getType)(testItem);
                if (info.caseType == utils_1.ItemType.File) {
            ...
            this.workspace.push(...vscode_1.workspace.workspaceFolders);
        }
        this.runCommand();
    }
    runCommand() {
        ...
        this.workspace.forEach(workspaceFolder => {
            const command = (0, child_process_1.spawn)('vendor/bin/pest', args, { cwd: workspaceFolder.uri.path });
            let suiteName = '';
            let isFailed = false;
            let isSkipped = false;
