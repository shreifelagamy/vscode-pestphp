...
const TestItemParser_1 = __importDefault(__webpack_require__(2));
const TestParentParser_1 = __importDefault(__webpack_require__(149));
const cp = __importStar(__webpack_require__(150));
const utils_1 = __webpack_require__(148);
...
function activate(context) {
    ...
    controller.resolveHandler = async (test) => {
        if (!test) {
            ...
            TestItemParser_1.default.resolveTestItem(test, controller);
        }
    ...
    async function discoverAllFiles() {
        ...
        vscode.workspace.workspaceFolders.map(async (workspaceFolder) => {
            TestParentParser_1.default.resolveTestParent(workspaceFolder, controller);
        }));
    }
    async function runHandler(shouldDebug, request, token, controller) {
        ...
        while (queue.length > 0 && !token.isCancellationRequested) {
            ...
            switch ((0, utils_1.getType)(test)) {
                case utils_1.ItemType.File:
                    if (test.children.size == 0) {
                        await TestItemParser_1.default.resolveTestItem(test, controller);
                    }
                    break;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const php_parser_1 = __webpack_require__(3);
const vscode = __importStar(__webpack_require__(1));
const utils_1 = __webpack_require__(148);
class TestItemParser {
    static async resolveTestItem(test, controller) {
        ...
        ast.children.filter(child => {
            ...
            utils_1.testData.set(childTestItem, utils_1.ItemType.TestCase);
        });
    }
}
exports["default"] = TestItemParser;
...
const tokens = __webpack_require__(32);
const AST = __webpack_require__(33);
...
const Position = __webpack_require__(15);
...
const Location = __webpack_require__(34);
const Position = __webpack_require__(15);
...
const Expr = __webpack_require__(36);
const KIND = "array";
...
const Node = __webpack_require__(37);
...
const Expression = __webpack_require__(36);
...
const Operation = __webpack_require__(44);
const KIND = "bin";
/**
 * Binary operations
 * @constructor Bin
...
const Statement = __webpack_require__(46);
const KIND = "block";
...
const Literal = __webpack_require__(48);
const KIND = "boolean";
...
const Declaration = __webpack_require__(56);
const KIND = "class";
...
const ConstantStatement = __webpack_require__(58);
...
const Function_ = __webpack_require__(82);
const KIND = "method";
...
const Reference = __webpack_require__(101);
const KIND = "name";
...
const Lookup = __webpack_require__(95);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ItemType = exports.getType = exports.testData = void 0;
exports.testData = new WeakMap();
const getType = (testItem) => exports.testData.get(testItem);
...
class TestParentParser {
    static async resolveTestParent(workspaceFolder, controller) {
        ...
        await classNamesWithTests.forEach(className => {
            ...
            if (classNames.length == 0 || !classNames.includes(theClassName)) {
                ...
                utils_1.testData.set(ParentTestItem, utils_1.ItemType.File);
                controller.items.add(ParentTestItem);
            }
        });
    }
}
exports["default"] = TestParentParser;
